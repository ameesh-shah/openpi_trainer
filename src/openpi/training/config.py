...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=RLDSDroidDataConfig(
            repo_id="rememberv2_dataset/1.0.0/",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            rlds_data_dir="rememberv2_dataset/1.0.0/",
            assets=AssetsConfig(assets_dir="gs://openpi-assets/checkpoints/pi0_fast_droid/assets", asset_id="droid"),
            action_space=droid_rlds_dataset.DroidActionSpace.JOINT_VELOCITY,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_fast_droid/params"),
    ...
    TrainConfig(
        ...
        data=RLDSDroidDataConfig(
            repo_id="remember_task_v3_dataset/1.0.0/",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            rlds_data_dir="remember_task_v3_dataset/1.0.0/",
            assets=AssetsConfig(assets_dir="gs://openpi-assets/checkpoints/pi0_fast_droid/assets", asset_id="droid"),
            action_space=droid_rlds_dataset.DroidActionSpace.JOINT_VELOCITY,
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_fast_droid/params"),
    ...
    TrainConfig(
        name="remembertaskfull_finetune",
        model=pi0.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
    ...
    TrainConfig(
        ...
        data=RLDSDroidDataConfig(
            repo_id="/home/jovyan/shared/ameesh/vla-data-assets/tfds_datasets/remember_task05_dataset/1.0.0/",
            # Set this to the path to your DROID RLDS dataset (the parent directory of the `droid` directory).
            rlds_data_dir="/home/jovyan/shared/ameesh/vla-data-assets/tfds_datasets/remember_task05_dataset/1.0.0/",
            assets=AssetsConfig(
                assets_dir="gs://openpi-assets-preview/checkpoints/pi05_droid/assets", asset_id="droid"
            ),
            action_space=droid_rlds_dataset.DroidActionSpace.JOINT_VELOCITY,
    ...
    TrainConfig(
        name="remembertaskfull_fromckpt",
        model=pi0.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
        ...
        # norm_stats=self._load_norm_stats(epath.Path("gs://openpi-assets/checkpoints/pi0_fast_droid/"))
        # freeze_filter=pi0_fast.Pi0FASTConfig(action_dim=8, action_horizon=10, freeze_vision=True).get_freeze_filter(),
        num_train_steps=1500,  # 100k steps should be sufficient, takes ~2 days on 8x H100s
        batch_size=128,
        log_interval=100,
        save_interval=500,
        keep_period=5000,
